...
#define GST_COMPLETION_HELPER_INSTALLED "/usr/lib/x86_64-linux-gnu/gstreamer1.0/gstreamer-1.0/gst-completion-helper"
...
#define GST_PACKAGE_NAME "GStreamer (Ubuntu)"

/* package origin */
#define GST_PACKAGE_ORIGIN "https://launchpad.net/distros/ubuntu/+source/gstreamer1.0"

/* GStreamer package release date/time for plugins as YYYY-MM-DD */
#define GST_PACKAGE_RELEASE_DATETIME "2019-12-03"

/* location of the installed gst-plugin-scanner */
#define GST_PLUGIN_SCANNER_INSTALLED "/usr/lib/x86_64-linux-gnu/gstreamer1.0/gstreamer-1.0/gst-plugin-scanner"

/* libexecdir path component, used to find plugin-scanner on relocatable
   builds on windows */
#define GST_PLUGIN_SCANNER_SUBDIR "gstreamer1.0"

/* plugin directory path component, used to find plugins on relocatable builds
   on windows */
#define GST_PLUGIN_SUBDIR "x86_64-linux-gnu"

/* location of the installed gst-ptp-helper */
#define GST_PTP_HELPER_INSTALLED "/usr/lib/x86_64-linux-gnu/gstreamer1.0/gstreamer-1.0/gst-ptp-helper"
