...
ACLOCAL = ${SHELL} /home/vandy/sources/gstreamer-1.0/gstreamer1.0-1.16.2/missing aclocal-1.16
...
AR = ar
AS = as
AUTOCONF = ${SHELL} /home/vandy/sources/gstreamer-1.0/gstreamer1.0-1.16.2/missing autoconf
AUTOHEADER = ${SHELL} /home/vandy/sources/gstreamer-1.0/gstreamer1.0-1.16.2/missing autoheader
AUTOMAKE = ${SHELL} /home/vandy/sources/gstreamer-1.0/gstreamer1.0-1.16.2/missing automake-1.16
AWK = mawk
BASH_COMPLETION_CFLAGS = 
BASH_COMPLETION_DIR = /usr/share/bash-completion/completions
BASH_COMPLETION_LIBS = 
BASH_HELPERS_DIR = /usr/share/bash-completion/helpers
BISON_PATH = /usr/bin/bison
CAP_LIBS = -lcap
CC = gcc
CCAS = gcc
CCASDEPMODE = depmode=none
CCASFLAGS = -g -O0 -fdebug-prefix-map=/home/vandy/sources/gstreamer-1.0/gstreamer1.0-1.16.2=. -fstack-protector-strong -Wformat -Werror=format-security -Wno-error
CCDEPMODE = depmode=none
CFLAGS = -g -O0 -fdebug-prefix-map=/home/vandy/sources/gstreamer-1.0/gstreamer1.0-1.16.2=. -fstack-protector-strong -Wformat -Werror=format-security -Wno-error
...
CXXFLAGS = -g -O0 -fdebug-prefix-map=/home/vandy/sources/gstreamer-1.0/gstreamer1.0-1.16.2=. -fstack-protector-strong -Wformat -Werror=format-security -Wno-error
CYGPATH_W = echo
DATADIR = /usr/share
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
...
GST_AGE = 1602
GST_ALL_CFLAGS = -I$(top_srcdir)/libs -I$(top_srcdir) -I$(top_builddir)/libs -I$(top_builddir) -pthread -I/usr/include/glib-2.0 -I/usr/lib/x86_64-linux-gnu/glib-2.0/include $(GLIB_EXTRA_CFLAGS) -fno-strict-aliasing $(GST_OPTION_CFLAGS) $(ERROR_CFLAGS) $(VISIBILITY_CFLAGS)
GST_ALL_CXXFLAGS = -I$(top_srcdir)/libs -I$(top_srcdir) -I$(top_builddir)/libs -I$(top_builddir) -pthread -I/usr/include/glib-2.0 -I/usr/lib/x86_64-linux-gnu/glib-2.0/include $(GLIB_EXTRA_CFLAGS) -fno-strict-aliasing $(GST_OPTION_CXXFLAGS) $(ERROR_CXXFLAGS)
GST_ALL_LDFLAGS = -no-undefined -Wl,-Bsymbolic-functions
GST_ALL_LIBS = -lgobject-2.0 -lgmodule-2.0 -pthread -lglib-2.0  $(GCOV_LIBS)
GST_API_VERSION = 1.0
GST_COMPLETION_HELPER_INSTALLED = /usr/lib/x86_64-linux-gnu/gstreamer1.0/gstreamer-1.0/gst-completion-helper
GST_CURRENT = 1602
...
GST_LIB_LDFLAGS = 
GST_LICENSE = LGPL
GST_LT_LDFLAGS =  -version-info 1602:0:1602
...
GST_PLUGIN_SCANNER_INSTALLED = /usr/lib/x86_64-linux-gnu/gstreamer1.0/gstreamer-1.0/gst-plugin-scanner
GST_PTP_HELPER_INSTALLED = /usr/lib/x86_64-linux-gnu/gstreamer1.0/gstreamer-1.0/gst-ptp-helper
...
HAVE_GMP = yes
HAVE_GSL = yes
HTML_DIR = ${prefix}/share/doc/gstreamer1.0-doc
...
LDFLAGS = -Wl,-Bsymbolic-functions -Wl,-z,relro -Wl,-z,defs -Wl,-O1 -Wl,--as-needed
...
LT_SYS_LIBRARY_PATH = 
MAINT = #
MAKEINFO = ${SHELL} /home/vandy/sources/gstreamer-1.0/gstreamer1.0-1.16.2/missing makeinfo
MANIFEST_TOOL = :
...
PACKAGE_STRING = GStreamer 1.16.2
...
abs_builddir = /home/vandy/sources/gstreamer-1.0/gstreamer1.0-1.16.2
abs_srcdir = /home/vandy/sources/gstreamer-1.0/gstreamer1.0-1.16.2
abs_top_builddir = /home/vandy/sources/gstreamer-1.0/gstreamer1.0-1.16.2
abs_top_srcdir = /home/vandy/sources/gstreamer-1.0/gstreamer1.0-1.16.2
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/vandy/sources/gstreamer-1.0/gstreamer1.0-1.16.2/install-sh
libdir = ${prefix}/lib/x86_64-linux-gnu
libexecdir = ${prefix}/lib/x86_64-linux-gnu/gstreamer1.0
